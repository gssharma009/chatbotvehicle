# backend/model.py — FINAL WORKING + health_check included
import os
import faiss
import pickle
import requests
...
def _load():
    ...
    if model is None:
        print("[INIT] Loading model & clean chunks...")
...
def answer_query(question: str) -> str:
    ...
    try:
        ...
        return "\n".join("• " + s.capitalize() for s in lines) if lines else "• No relevant information found."
